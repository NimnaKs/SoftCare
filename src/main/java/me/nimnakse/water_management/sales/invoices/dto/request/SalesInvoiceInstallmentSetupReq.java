...
public record SalesInvoiceInstallmentSetupReq(
        ...
        @Min(value = 2000, message = "installmentStartYear must be >= 2000") @Max(value = 2100, message = "installmentStartYear must be <= 2100") Integer installmentStartYear,
        @Min(value = 1, message = "installmentStartMonth must be between 1 and 12") @Max(value = 12, message = "installmentStartMonth must be between 1 and 12") Integer installmentStartMonth
) {
}
