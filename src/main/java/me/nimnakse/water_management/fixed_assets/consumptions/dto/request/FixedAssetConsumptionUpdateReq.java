package me.nimnakse.water_management.fixed_assets.consumptions.dto.request;
...
public record FixedAssetConsumptionUpdateReq(
        @NotNull(message = "Fixed asset template id is required") Long fixedAssetTemplateId,
